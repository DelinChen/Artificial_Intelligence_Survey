...
def run_q4():
	...
	for x in range(105):
		if stop == False:
			...
			if csp_sol0 != None:
				...
				print("Ice Breaker Problem for p = 0.1, n = 105 ")
	...
	for x in range(105):
		if stop == False:
			...
			if csp_sol2 != None:
				...
				print("Ice Breaker Problem for p = 0.3, n = 105")
	...
	for x in range(105):
		if stop == False:
			...
			if csp_sol3 != None:
				...
				print("Ice Breaker Problem for p = 0.4, n = 105")
	...
	for x in range(105):
		if stop == False:
			...
			if csp_sol4 != None:
				...
				print("Ice Breaker Problem for p = 0.5, n = 105")
	...
	for x in range(105):
		if stop == False:
			...
			csp_sol5 = min_conflicts(iceBreaker5)
			
			if csp_sol5 != None:
				end = time.time() 
				print("Ice Breaker Problem for p = 0.6, n = 105")
